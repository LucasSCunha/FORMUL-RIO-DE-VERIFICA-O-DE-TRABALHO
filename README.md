...
- **63 itens de verificação** organizados em 4 seções:
  - Premissas Básicas (itens 1–19)
  - Critérios de Armazenamentos — Área de Postes (itens 20–32)
  - Área Interna e Externa — Cruzetas, Condutores, Ferragens, Transformadores, etc. (itens 33–53)
  - Sucatas, Área Segregada e Processamento de Materiais (itens 54–63)
- **Avaliação SIM / NÃO / N/A** com destaque visual por cores
- **Campo de Evidência Objetiva** por item
